 ...
 */
class EthereumController extends PaymentController
{
    /**
    ...
    public function topUp()
    {
        ...
        try {
            ...
            $getnewaddress = $ethereum->getnewaddress($transaction);
        } catch (\Exception $e) {
            \Log::error('Can not create ethereum wallet: '.$e->getMessage());
